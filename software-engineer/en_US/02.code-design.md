...
In this interview you'll be given a problem to be solved using low-level components such as
classes and functional namespaces. The scope of it will be an application/service.
